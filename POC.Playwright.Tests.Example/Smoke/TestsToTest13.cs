...
{
    [TestFixture]
    public class TestsToTest13 : BasePageTest
    {
        [Category("Cart")]
        [Test(Description = "Verify product was added to a cart. TestsToTest13.Test1")]
        public async Task Test1()
        {
            ...
            await Assertions.Expect(Page.Locator(cartPage._cartItemSelector)).ToHaveTextAsync("shdjsad");
        }

        [Category("Cart")]
        [Test(Description = "Verify product was added to a cart. TestsToTest13.Test2")]
        ...
        [Category("Cart")]
        [Test(Description = "Verify product was added to a cart. TestsToTest13.Test3")]
        ...
        [Category("Cart")]
        [Test(Description = "Verify product was added to a cart. TestsToTest13.Test4")]
